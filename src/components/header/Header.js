...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 w-4/5 mt-[40px] flex items-center bg-transparent z-10 bg-gradient-to-r from-[${color}] to-[#ad0b97] font-[${color2}] text-[${sellerListdata.text_color_1}]`}
    >
