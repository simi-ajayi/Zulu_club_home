...
const CategoriesMenu = () => {
  ...
  const getCat = async () => {
    ...
    axios.post(url + '/app/v1/api/seller_category_list', json)
      .then((res) => {
  ...
  return (
    <div className="mt-10">
      <div className="mt-5">
        ...
        <div className="flex justify-between mt-5 gap-8 mt-5">
        {categoriesdata && categoriesdata.map(user => (

          <Card2 className="p-4" zulu_category_name={user.zulu_category_name}
